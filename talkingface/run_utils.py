...
def calc_face_mat(pts_array_origin, face_pts_mean, fit = True):
    '''

    :param pts_array_origin: mediapipe检测出的人脸关键点
    :return:
    '''
    face_pts_mean_rotatePts = face_pts_mean
    ...
    if not fit:
        return mat_list, pts_normalized_list, face_pts_mean_rotatePts
